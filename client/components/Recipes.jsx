...
class Recipes extends React.Component{
  ...
  return (
    ...
    drinks.map((drink, i) => (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16" onClick={() => this.handleClick(drink.strDrink)}>
